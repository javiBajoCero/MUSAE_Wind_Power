...
while ((kk<1000)&&(err>1e-6))
 ...
 %limiting power to nominal power
    if P1a >= Nominal_power
        P1a=Nominal_power;
    end
...
for i = 1:1:length(Pauxmec)
    if Pauxmec(i) >= Nominal_power
        Pauxmec(i)=Nominal_power;
    end
end
